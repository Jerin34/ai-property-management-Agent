...
import {createMaintenaceUpdate as createMaintenaceUpdateService} from '../services/maintenace-updates.service.js';
export const createMaintenaceUpdate = async (req:Request,res:Response):Promise<void>=>{
    try{
        ...
        await createMaintenaceUpdateService(maitenanceId,user.userId,user.role,message);
